...
# --- Sources ------------------------------------------------------------------
SRC = src/main.c src/vector_graphics.c src/game.c src/vector_font.c src/audio.c src/ui.c src/world_builder.c src/ai.c src/ui_hud.c src/state.c src/game_data.c src/drone_chatter.c src/enemy_rustweaver.c src/enemy_ascian.c src/enemy_lictor.c src/enemy_emp_sentinel.c
OBJ = $(SRC:.c=.o)
